...
use artkost\uikit\Breadcrumbs;
use yii\helpers\Html;
use frontend\assets\MinimalAsset;

MinimalAsset::register($this);
?>
<?php $this->beginPage() ?>
<!DOCTYPE html>
...
<body class="">
    ...
    <div class="uk-offcanvas-content">
        <div class="uk-section-primary tm-section-intro">
            <div uk-sticky="media: 960;show-on-up: true;animation: uk-animation-slide-top;cls-inactive: uk-navbar-transparent;top: 400" class="uk-navbar-container tm-navbar-container uk-light uk-sticky uk-navbar-transparent" style="">
...
<?php endif ?>
                            <?= Yii::$app->user->isGuest ? Html::a(
                                ...
                                . Html::submitButton(
                                    '<span data-uk-icon="icon: sign-out" class="text-capitalize">' . strtoupper(Yii::$app->user->identity->username)  . ' </span>',
        ...
        <footer class="uk-section tm-primary-color-dark uk-light uk-text-center">
            <div class="uk-container">
                ...
                <div class="uk-margin-medium tm-text-xsmall uk-text-meta copyright">
                    Copyright &copy <?= date('Y') ?> by <a href="#">LPPM</a>
                </div>
            </div>
        </footer>
        ...
        <div id="search" class="uk-flex-top uk-background-primary uk-modal-search uk-light" data-uk-modal>
            ...
            <div class="uk-modal-dialog uk-text-center uk-margin-auto-vertical uk-padding-large">
                ...
                ?>
                <input class="uk-search-input uk-text-center" name="id" type="search" placeholder="Masukkan Kode Pengaduan...">
                <?= Html::endForm()
                ?>
            </div>
        </div>
