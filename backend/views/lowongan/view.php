        ...
        <?= DetailView::widget([
            ...
            'attributes' => [
                ...
                [
                    ...
                    data-toggle="modal" data-target="#foto-' . $model->lowongan_id . '"><img src="' . Yii::getAlias('@frontend') . '/web/lowongan/' . $model->file . '" width="60px" height="60px"/></button>
                      ...
                      <div class="modal-dialog modal-lg" role="document">
                        <div class="modal-content">
                          ...
                          <div class="modal-body text-center">
                                <img src="' . Yii::getAlias('@frontend') . '/web/lowongan/' . $model->file . '" width="800px"/>
                          </div>
